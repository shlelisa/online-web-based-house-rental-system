...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Available Apartement House</title>
...
?>		
				...
				<br><br><br>
				<div style="padding:50px;margin:30px;margin-left:300px;"class="card-box mb-20">
...
<?php
$sql=mysqli_query($conn,"select * from rent_home WHERE category='Apartement' AND payment='0'");
$cnt=1;
...
<div style="margin-left:300px" class="modal fade bs-example-modal-xl" id="view_modal<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				...
				<div class="col-md-20">
					...
					<div class="pull-center">
						<center><h4><p class="mb-60">Normal House Home Information</p></h4></center>
						</div>
	...
	<div style="margin-left:300px" class="modal fade bs-example-modal-xl" id="update_modal<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				...
				<div class="col-md-12">
					...
					<div class="pull-center">
						<center><h4><p class="mb-30">Update Normal House Information</p></h4></center>
						</div>
