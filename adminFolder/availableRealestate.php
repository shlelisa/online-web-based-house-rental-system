...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Available Real Estate House</title>
...
<?php
$sql=mysqli_query($conn,"select * from rent_home WHERE category='Real Estate' AND payment='0'");
$cnt=1;
...
<div style="margin-left:300px" class="modal fade bs-example-modal-xl" id="view_modal<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				...
				<div class="col-md-20">
					...
					<div class="pull-center">
						<center><h4><p class="mb-60">Real Estate Home Information</p></h4></center>
						</div>
						...
						<input type="hidden" name="id7" value="21">
							...
							<div class="col-md-4 col-sm-12">
								...
								<div class="form-group">
									...
									<input type="text" name="lgaa6" class="form-control" readonly value="<?php echo $row['username']?>">
								</div>
								</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
	...
	<div style="margin-left:300px" class="modal fade bs-example-modal-xl" id="update_modal<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				...
				<div class="col-md-12">
					...
					<div class="pull-center">
						<center><h4><p class="mb-30">Update Real Estate Information</p></h4></center>
						</div>
