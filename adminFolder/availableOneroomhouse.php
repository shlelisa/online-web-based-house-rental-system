...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Available One Room House</title>
...
<?php
$sql=mysqli_query($conn,"select * from rent_home WHERE category='One room house' AND payment='0'");
$cnt=1;
...
<div style="margin-left:300px" class="modal fade bs-example-modal-xl" id="view_modal<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				...
				<div class="col-md-20">
					...
					<div class="pull-center">
						<center><h4><p class="mb-60">One room Home Information</p></h4></center>
						</div>
	...
	<div style="margin-left:300px" class="modal fade bs-example-modal-xl" id="update_modal<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
				...
				<div class="col-md-12">
					...
					<div class="pull-center">
						<center><h4><p class="mb-30">Update One room house Information</p></h4></center>
						</div>
						...
						<input type="hidden" name="id7" value="21">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label>Id</label>
									<input type="text" name="id" readonly  class="form-control"  value="<?php echo $row['id']?>">
								</div>
								</div>
								<div class="col-md-4 col-sm-12">
								<div class="form-group">
							...
							<div class="col-md-4 col-sm-12">
								...
								<div class="form-group">
									<label>About Home</label>
									<textarea  name="about_home" required  > <?php echo $row['about_home']?></textarea>
								</div>
								</div>
								<div class="col-md-4 col-sm-12">
								<div class="form-group">
