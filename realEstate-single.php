	...
	if(isset($_POST['booking'])){
		if($_SESSION['alogin']==""){
			echo'<script type="text/javascript">window.location="login.php?page=realEstate-single"; </script>';
	}else{
                                            ...
                                            <div class="dropdown dropdown-lg">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="checkbox">
                                                            <label><input type="checkbox">Find Your Real Estate</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    ...
                    <p class="page-description">More Details About Real Estate</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div><!-- /.page-header -->
        						...
        						<form method="post" enctype="multipart/form-data" class="advance_search_query booking-form">
        							<div class="form-bg seven">
        								<div class="form-content">
                                            <h2 class="form-title">Book This Real Estate</h2>
