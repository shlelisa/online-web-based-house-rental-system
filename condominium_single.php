	...
	if(isset($_POST['booking'])){
		if(strlen($_SESSION['alogin'])==0){
			echo'<script type="text/javascript">window.location="login.php?page=condominium-single"; </script>';
	}else{
                                            ...
                                            <div class="dropdown dropdown-lg">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                    <div class="form-horizontal">
                                                        ...
                                                        <div class="checkbox">
                                                            <label><input type="checkbox">Find Your Condominium</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    ...
                    <p class="page-description">More Details About Condominium</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div><!-- /.page-header -->
...
{ ?>
    				<div class="family-apartment-content mobile-extend">
    					...
    					<div class="price-details">
    						<h3>Price Details-</h3>
    						<ul>
    							<li><span><?php echo $row['rentingMethod'];?> : </span> <?php echo $row['rent']; ?></li>
        						...
        						<form method="post" enctype="multipart/form-data" class="advance_search_query booking-form">
        							<div class="form-bg seven">
        								<div class="form-content">
                                            <h2 class="form-title">Book This Condominium</h2>
