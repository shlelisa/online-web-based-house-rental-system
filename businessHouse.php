        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    ...
                    <p class="page-description">All Business House List</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div><!-- /.page-header -->
				...
				$sql=mysqli_query($conn,"SELECT * FROM rent_home WHERE status='active' AND category='Business house' AND payment ='0' ORDER BY id DESC Limit 10");
				$cnt=1;
									...
									<div style="background-color:white" class='col-md-4 col-sm-6 col-xs-6'>
                                        ...
                                        <div class='apartments-content'>
                                            <div class='image-content'>
                                               <a href='businessHouse-single.php?id=<?php echo $row['id'];?>'>
   ...
   <?php } ?>
                                            ...
                                            <div class='text-content'>
                                                <div class='top-content'>
                                                    <h3>
                                                        <a href='businessHouse-single.php'?id=<?php echo $row['id'];?> >Business House</a>
