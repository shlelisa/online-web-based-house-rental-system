        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (status == 'true') {
              ...
              // table.cell(parseInt(trid) - 1,3).data(password);
              // table.cell(parseInt(trid) - 1,4).data(role);
              var button = '<td><a href="javascript:void();" data-id="' + id + '" class="btn btn-info btn-sm editbtn">Edit</a> <a href="#!"  data-id="' + id + '"  class="btn btn-danger btn-sm deleteBtn">Delete</a></td>';
              var row = table.row("[id='" + trid + "']");
              row.row("[id='" + trid + "']").data([id, username, email, password, role, button]);
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              <label for="nameField" class="col-md-3 form-label">Username</label>
              <div class="col-md-9">
            ...
            <div class="mb-3 row">
              <label for="cityField" class="col-md-3 form-label">role</label>
              <div class="col-md-9">
                <input type="text" class="form-control" id="cityField" name="role">
              </div>
            </div>
