            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="heading-content-one">
                        ...
                        <h5 class="sub-title">Welcome to our House Rent Project</h5>
                    </div><!-- /.heading-content -->
                </div><!-- /.col-md-12 -->
            </div><!-- /.row -->
                        ...
                        <p>House rent service is used to connect the tenant and the property owner. We can help you find a rental property without having to go through the hassle of looking for one. By using this website, you can avoid any fraud that may occur. Also, it provides you with the easiest way to find what you are looking for without getting sunburned.</p>
   ...
   <?php } ?>
                    ...
                    <div class="col-md-5">
                        <div class="gallery-right-content">
                            ...
                            <h3>Best of our <br/>Event Photos and Vedeos</h3>
                    ...
                    <article class="post">
                        <figure class="post-thumb">
                            <a href="blog-single.php">
                                ...
                                <?php if($row['photo']==""){ ?>
   <img  style="width:400px; height:250px" src="NewsPhoto/noimage.png"><?php } else {?>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="contact">
                                    ...
                                    <p>Bule Hora University, 4th Year Software Engineering Student Lelisa and Gutama</p>
                                </div><!-- /.contact -->
                            </div><!-- /.col-md-6 -->
                            <div class="col-md-6 col-sm-6">
                                <div class="contact">
                                    <h4><i class="fa fa-envelope"></i>Mail</h4>
                                    <p>shlelisa123@gmail.com</p>
                                </div><!-- /.contact -->
                            </div><!-- /.col-md-6 -->
                        </div><!-- /.row -->
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="contact">
                                    ...
                                    <div class="social-icon">
                                     <a href="htts://www.facebook.com/profile.php?id=100064513522573"><i class="fa fa-facebook"></i></a>
                                        <a href="mailto:shlelisa123@gmail.com"><i class="fa fa-google-plus"></i></a>
                                    </div><!-- /.Social-icon -->
                                </div><!-- /.contact -->
                            </div><!-- /.col-md-6 -->
                        </div><!-- /.row -->
