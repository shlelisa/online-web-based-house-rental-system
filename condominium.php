        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    ...
                    <p class="page-description">All Condominium List</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div><!-- /.page-header -->
				...
				$sql=mysqli_query($conn,"SELECT * FROM rent_home WHERE status='active' AND category='Condominium' AND payment ='0' ORDER BY id DESC");
				$cnt=1;
   ...
   <?php } ?>
                                            ...
                                            <div class='text-content'>
                                                <div class='top-content'>
                                                    <h3>
                                                        <a href='condominium_single.php'?id=<?php echo $row['id'];?> >Condominium</a>
