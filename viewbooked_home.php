                      ...
                      <fieldset style="background-color:white">
                        ...
                        <div class="form-group">
	                     ...
	                     <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><input id="rentingMoney" name="rentingMoney" placeholder="Enter Amount" class="form-control" readonly="true" style="background-color:transparent;border-top-style: hidden;border-right-style: hidden;border-left-style: hidden;border-bottom-style: hidden;" value="<?php echo $row['rent']; ?>" type="text"></div>
                            </div>
                         </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               ...
                               <select name="sel" readonly style="border-top-style: hidden;border-right-style: hidden;border-left-style: hidden;border-bottom-style: hidden;background-color:transparent;"  class="selectpicker form-control">
                                    <option value="Apartement" <?php if ($row['category'] == "Apartement")
        {
            echo "selected";
        } ?>>Apartement</option>
									<option value="Condominium" <?php if ($row['category'] == "Condominium")
        {
            echo "selected";
        } ?>>Condominium</option>
									<option value="Real Estate" <?php if ($row['category'] == "Real Estate")
        {
            echo "selected";
        } ?>>Real Estate</option>
									<option value="Normal House" <?php if ($row['category'] == "Normal House")
        {
            echo "selected";
        } ?>>Normal House</option>
									<option value="One room house" <?php if ($row['category'] == "One room house")
        {
            echo "selected";
        } ?>>One room house</option>
									<option value="Business house" <?php if ($row['category'] == "Business house")
        {
            echo "selected";
        } ?>>Business house</option> 
								</select>
                                </div>
                            </div>
                         </div>
